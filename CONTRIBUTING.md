...
Be professional. Critique ideas, not people. See [CODE_OF_CONDUCT.md](CODE_OF_CONDUCT.md) for the full standard. Issues and PRs that violate it are closed without discussion.

## Governance

Decisions follow a benevolent-maintainer model — issue first, alignment check against the anti-vision, then review and merge. See [GOVERNANCE.md](GOVERNANCE.md) for who decides and how.

---

## Questions

Questions and general discussion belong in [GitHub Discussions](https://github.com/eddiebelaval/squire/discussions). For where to go by need, see [SUPPORT.md](SUPPORT.md), or reach out on X: [@eddiebe](https://x.com/eddiebe).
